...
export default function App() {
  ...
  // 🟢 Lecture auto quand on ouvre un lien partagé
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Carte */}
      <div className="bg-white/20 backdrop-blur-lg p-6 rounded-2xl max-w-md shadow-xl relative border-4 animate-glow">
        ...
        {resultat && (
          <button
            ...
            className="p-3 mt-3 bg-blue-900 hover:bg-blue-700 rounded-lg"
          >
            Partager 🎁
          </button>
        )}
