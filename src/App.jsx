...
export default function App() {
  ...
  // 🔁 TEXTE DON (changement toutes les 4 secondes)
  const messagesDon = [
    "❤️ Soutien solidaire aux familles vulnérables ❤️",
    "🤝 Geste de solidarité – aide humanitaire 🤝",
  ];
  const [texteDon, setTexteDon] = useState(messagesDon[0]);
