...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (params.get("from")) {
      ...
      setResultat(
        msgType === "annee" ? (
          <>
            🎉 Bonne Année de la part de <NomAnime texte={exp} /> !
          </>
        ) : (
          <>
            🎄 Joyeux Noël de la part de <NomAnime texte={exp} /> !
          </>
        )
      );
  ...
  function genererMessage() {
    ...
    const nomAffiche = nom || expediteur || "Moi";

    if (typeMessage === "noel") {
      setResultat(
        <>
          🎄 Joyeux Noël de la part de <NomAnime texte={nomAffiche} /> !
        </>
      );
      ...
      setResultat(
        <>
          🎉 Bonne Année de la part de <NomAnime texte={nomAffiche} /> !
        </>
      );
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center text-white p-4 text-center bg-cover bg-center bg-fixed relative"
      style={{
        backgroundImage: `
        linear-gradient(to bottom, rgba(13,27,42,0.9), rgba(27,38,59,0.9)),
        url('/bg1.jpg'), url('/bg2.jpg'), url('/bg3.jpg'), url('/bg4.jpg')
      `,
      }}
    >
      <div className="bg-white/20 backdrop-blur-lg p-6 rounded-2xl max-w-md shadow-xl relative animate-glow">
        ...
        <button
          ...
          className="w-32 p-3 mt-4 bg-red-600 rounded-lg"
        >
          Écouter
        </button>
        ...
        {resultat && (
          <button
            ...
            className="p-3 mt-3 bg-blue-900 rounded-lg"
          >
            Partager 🎁
          </button>
        )}
